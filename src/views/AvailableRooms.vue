<template>
  <main>
    ...
    <section class="bg-color-secondary pb-5" style="height: 700px: scroll" id="section2" >
      <div class="con-rooms m-auto pb-9">
        ...
        <div class="flex flex-wrap justify-between">
          ...
          <div class="max-w-md card_two bg-white rounded-lg ">
            ...
            <h3 class="font-bold text-lg m-4">Standard twin ben, Multiple beds</h3>
...
export default {
  ...
  data() {
    return {
      ...
      starOne: "src/assets/images/availableRooms/star-s-fill 4.svg",
