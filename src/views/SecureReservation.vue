      ...
      <div class="left " style="margin-top: 48px">
        ...
        <div class="three bg-white rounded-lg w-full  mt-9 pb-4">
          ...
          <ol class="w-3/4 mt-7 ml-10 list-decimal leading-7" >
            <li>This rate is non-refundable. If you change or cancel your booking you
                 will not get a refund or credit to use for a future stay.</li>
          ...
          <p class="w-3/4 mt-4 ml-7  ">By clicking the button below, I acknowledge that I have reviewed the Privacy Statement 
            and have reviewd and accept the Rules and Restrictions and Terms of Use.</p>
            <button   class="w-1/4 ml-7 mt-6 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-color-primary rounded-md focus:outline-none"
